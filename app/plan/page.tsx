              ...
              <div className="relative pl-5">
                ...
                {plan.macro.phases.map((p, i) => (
                  <div key={i} className="relative pb-5 last:pb-0">
                    <div className="absolute -left-[14px] top-1 w-3 h-3 rounded-full bg-accent border-2 border-card" />
                    ...
                    {p.notes && <div className="text-sm text-muted/80 mt-0.5">{p.notes}</div>}
                  </div>
                ))}
              </div>
            </Card>
                  ...
                  .map((d, i) => (
                    <div key={i} className="flex gap-3 rounded-xl border border-border p-3">
                      <div
                        ...
                        style={{ backgroundColor: DAY_TYPE_COLOR[d.type] ?? "#cbd5e1" }}
                      />
